...
proc usage { } {
	...
	puts "and the user is asked which SP if neither'-A' or '-B' was entered."
	puts "";
	puts "logging is not enabled by default. if logging is enable with a ";
	puts "'-l' cmd, all cmds that are executed will be logged in five ";
