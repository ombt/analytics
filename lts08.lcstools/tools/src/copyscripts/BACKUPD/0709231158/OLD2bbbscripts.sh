...
#
proc traverse { labid branch current scripts_name stack_name script type number suffix spaces childfound_name { maxchildnumber 5 } } {
	...
	if {${newchildfound} <= 0} {
		...
		puts "${oldspaces}DEPTH: [depth stack]";
