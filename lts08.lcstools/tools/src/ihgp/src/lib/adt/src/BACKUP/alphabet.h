...
ostream &
operator<<(ostream &, const Alphabet<DataType> &);

template <class DataType> 
ostream &
operator<<(ostream &, const Word<DataType> &);
...
public:
	...
	// output operators
        friend ostream &operator<<(ostream &, const Alphabet<DataType> &);
        friend ostream &operator<<(ostream &, const Word<DataType> &);
