...
main(int, char **)
{
	...
	while (cmd != 'q')
	{
		...
		case 'p':
		{
			...
			BinaryTree_AVL_Iterator_PreOrder<String> iter(bt);
			for ( ; ! iter.done(); iter++)
			{
				cout << iter() << " ";
			}
		...
		case 'o':
		{
			...
			BinaryTree_AVL_Iterator_PostOrder<String> iter(bt);
			for ( ; ! iter.done(); iter++)
			{
				cout << iter() << " ";
			}
		...
		case 'n':
		{
			...
			BinaryTree_AVL_Iterator_InOrder<String> iter(bt);
			for ( ; ! iter.done(); iter++)
			{
				cout << iter() << " ";
			}
		...
		case 'l':
		{
			...
			BinaryTree_AVL_Iterator_LevelOrder<String> iter(bt);
			for ( ; ! iter.done(); iter++)
			{
				cout << iter() << " ";
			}
