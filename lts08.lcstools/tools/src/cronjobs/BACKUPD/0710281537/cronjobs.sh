...
31 04 * * 1-5 /home/lcstools/tools/bin/savemgmain -t oper -G -R 2>&1 | mailx -s "savemgmain output" lcstools@lts08.ih.lucent.com mrumore@lucent.com
31 05 * * 1-5 /home/lcstools/tools/bin/save6.3.0 -t oper -G -R 2>&1 | mailx -s "savemgmain output" lcstools@lts08.ih.lucent.com mrumore@lucent.com
EOF
