...
proc getsplogfile { labid activesp activeip ftppath } {
	...
	remote_exec $ip_id "tar czvf /home/${labid}_${activesp}_log.tar.gz /Telica/swCPU/CurrRel/log /Telica/swCPU/CurrRel/old* /Telica/dbCurrent/*log /Telica/dbCurrent/*bak /Telica/History" 600;
	#
	close_telnet $ip_id;
	#
	if {$ftppath != ""} {
