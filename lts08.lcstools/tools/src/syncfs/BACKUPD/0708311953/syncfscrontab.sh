...
#
echo "00 1 * * * /home/lcstools/tools/bin/lcssyncfs /lcsl100/tmp/basescripts /home2/tester/bin/lcstools/lcsl100/basescripts 1>/lcsl100/tmp/nightlysyncfs.out 2>&1" >>${newcrontab}
#
crontab < ${newcrontab}
#
echo
