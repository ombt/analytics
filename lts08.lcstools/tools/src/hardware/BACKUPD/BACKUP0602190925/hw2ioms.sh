...
nawk 'BEGIN {
	verbose = '"${verbose}"'
	#
	cleis["ba1ax60aab"] = "voip";
	cleis["ba2a30tgaa"] = "ena";
	cleis["ba2a30tgab"] = "ena";
	cleis["ba4a701faa"] = "octds3_2";
	cleis["ba7atp0faa"] = "ds1_2";
	cleis["ba9ats0faa"] = "cm";
	cleis["ba9ats0fab"] = "cm";
	cleis["ba9axy0faa"] = "octds3_3";
	cleis["ba9iaa0aaa"] = "ds1";
	cleis["bauiaa1eab"] = "vs3";
	cleis["bauiadpeaa"] = "ena2";
	cleis["ba4a60zfaa"] = "trids3_3";
}
$0 ~ /^FILE:/ {
	split($0, data, /\//);
	labid = data[2];
