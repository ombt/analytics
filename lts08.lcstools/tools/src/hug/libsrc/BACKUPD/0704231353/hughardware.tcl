...
#
proc hw_tl1_open { spid spip login passwd { vflag 0 } { tmout 15 } { tl1port 2361 } { maxlogons 12 } } {
	upvar $spid spawn_id;
	#
...
#
proc hug_waitforcpustate { cfgdata vflag tmout spdata { interiterationsleeptime 30 } } {
	upvar $cfgdata cfgd;
	upvar $spdata spd;
	# sanity checks
	#
