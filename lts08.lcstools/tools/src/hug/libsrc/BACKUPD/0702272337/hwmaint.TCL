...
#
set flashparts(ana) "kdi";
set flashparts(atmds3) "kdi";
set flashparts(cm) "kdi";
set flashparts(cpu) "kdi";
set flashparts(debug_cpu) "kdi";
set flashparts(ds1) "kdi";
set flashparts(ds1_2) "kdi";
set flashparts(ds3) "kdi";
set flashparts(e1) "kdi";
set flashparts(ena) "ife efe kdi";
set flashparts(ena2) "ife efe kdi";
set flashparts(octds3) "kdi";
set flashparts(octds3_2) "kdi";
set flashparts(octds3_3) "kdi";
set flashparts(pna) "kdi";
set flashparts(tdmoc) "kdi";
set flashparts(trids3) "kdi";
set flashparts(trids3_3) "kdi";
set flashparts(voip) "kdi";
set flashparts(voip6) "kdi";
set flashparts(vs2) "kdi";
set flashparts(vs3) "kdi";
#
# clean up routine ...
#
...
#
proc hw_maint_update_faulted_ioms { spid labid spaip spbip { faultstates "oosaumaflt" } { lynxusername "root" } { lynxpasswd "plexus9000" } } {
	upvar $spid spawn_id;
	#
	puts "\nAttempting to update ${faultstates} IOMS:";
	#
	return "-1 - unable to update IOMs";
}
#
...
proc hw_maint_cpymem_all_ioms { labid spaip spbip tl1username tl1passwd { recoverioms 0 } { lynxusername "root" } { lynxpasswd "plexus9000" } { maxcpymems 3 } { maxiom 17 } { polltime 30 } { maxtime 1800 } { maxresets 5 } } {
	...
	if {!$done} {
		...
		set status [hw_maint_update_faulted_ioms spid $labid $spaip $spbip "oosaumaflt" $lynxusername $lynxpasswd]
		if {[isNotOk $status]} {
			hw_maint_close $spid;
