...
EOF
		...
		*hardware*)
			...
			then
				...
				#
				echo "	tl1 rmvallioms -v tl1sp" >>${duplexscript}
				echo "	tl1 rmvallioms -v tl1sp" >>${simplexspascript}
				echo "	tl1 rmvallioms -v tl1sp" >>${simplexspbscript}
				#
				...
				echo "	tl1 rstallioms -v tl1sp" >>${duplexscript}
				echo "	tl1 rstallioms -v tl1sp" >>${simplexspascript}
				echo "	tl1 rstallioms -v tl1sp" >>${simplexspbscript}
			fi
			;;
		*iproute*)
			;;
