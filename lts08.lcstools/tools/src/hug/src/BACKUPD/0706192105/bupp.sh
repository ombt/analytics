...
removeload exec {
	...
	#
	telnet exec -i -v telnetspa [ -h /Telica/dbCurrent ] && /Telica/swCPU/CurrRel/system/scripts/restore_dbCurrent;
	telnet exec -v telnetspa [ -d /Telica/dbCurrent ]
	telnet exec -i -v telnetspb [ -h /Telica/dbCurrent ] && /Telica/swCPU/CurrRel/system/scripts/restore_dbCurrent;
