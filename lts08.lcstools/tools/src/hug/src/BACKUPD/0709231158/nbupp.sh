...
removeload exec {
	...
	ftp put ftpspa <ftp.scriptsdir>/remove_hd2e /home/remove_hd2e
	...
	ftp put ftpspb <ftp.scriptsdir>/remove_hd2e /home/remove_hd2e
	#
	ftp close ftpspa
	ftp close ftpspb
	#
	...
	telnet exec telnetspa /bin/chmod 755 /home/remove_hd2e
	telnet exec telnetspb /bin/chmod 755 /home/remove_hd2e
	#
	# sleep 1200
	#
	...
	#
	# restore dbCurrent if it was moved.
	#
	telnet exec -t300 -i -v telnetspa [ -h /Telica/dbCurrent ] && /Telica/swCPU/CurrRel/system/scripts/restore_dbCurrent;
	telnet exec -v telnetspa [ -d /Telica/dbCurrent ]
	telnet exec -t300 -i -v telnetspb [ -h /Telica/dbCurrent ] && /Telica/swCPU/CurrRel/system/scripts/restore_dbCurrent;
	telnet exec -v telnetspb [ -d /Telica/dbCurrent ]
	#
	telnet exec -i -v telnetspa /home/remove_timesten
	telnet exec -i -v telnetspb /home/remove_timesten
	# telnet exec -i -v telnetspa /home/remove_hd2e
	# telnet exec -i -v telnetspb /home/remove_hd2e
	#
...
EOF
		...
		*hardware*)
			...
			then
				...
				if [[ "${updateioms}" == yes ]]
				then
					echo "	tl1 updateioms -v tl1sp ${maxcpymems}" >>${duplexscript}
					echo "	tl1 updateioms -v tl1sp ${maxcpymems}" >>${simplexspascript}
					echo "	tl1 updateioms -v tl1sp ${maxcpymems}" >>${simplexspbscript}
				fi
				#
				echo "	tl1 cpymems -v tl1sp ${maxcpymems}" >>${duplexscript}
				echo "	tl1 cpymems -v tl1sp ${maxcpymems}" >>${simplexspascript}
				echo "	tl1 cpymems -v tl1sp ${maxcpymems}" >>${simplexspbscript}
				#
...
then
	...
	then
		...
		nupsh -I -U $outfile 2>&1 | tee ${logfile}
...
EOF
			...
			do
				...
				#
				nupsh -U -s $section -c 1 $outfile 2>&1
				if [[ $? -ne 0 ]]
				then
					echo
					echo "ERROR: Section $section failed."
