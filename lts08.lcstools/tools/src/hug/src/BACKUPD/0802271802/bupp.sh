...
removeload exec {
	...
	# 
	telnet exec -i -v telnetspa [ -d /home_f ] && rm -rf /home_f/*;
	telnet exec -i -v telnetspa [ -d /home_g ] && rm -rf /home_g/*;
	telnet exec -i -v telnetspb [ -d /home_f ] && rm -rf /home_f/*;
	telnet exec -i -v telnetspb [ -d /home_g ] && rm -rf /home_g/*;
	#
	...
	telnet exec -v -t60 telnetspa cd SAVEdbCurrent
	...
	telnet exec -v -t60 telnetspb cd SAVEdbCurrent
