...
select
    ...
    get_delta(curr.actual,
              prev.actual) as actual,
    ...
    get_delta(curr.cderr,
              prev.cderr) as cderr,
    get_delta(curr.change,
              prev.change) as change,
    ...
    get_delta(curr.cwait,
              prev.cwait) as cwait,
    get_delta(curr.dataedit,
              prev.dataedit) as dataedit,
    ...
    get_delta(curr.mente,
              prev.mente) as mente,
    get_delta(curr.mhrcgstop,
              prev.mhrcgstop) as mhrcgstop,
    get_delta(curr.mount,
              prev.mount) as mount,
    get_delta(curr.otherlstop,
              prev.otherlstop) as otherlstop,
    get_delta(curr.othrstop,
              prev.othrstop) as othrstop,
    get_delta(curr.poweron,
              prev.poweron) as poweron,
    get_delta(curr.prdstop,
              prev.prdstop) as prdstop,
    get_delta(curr.prod,
              prev.prod) as prod,
    get_delta(curr.prodview,
              prev.prodview) as prodview,
    ...
    get_delta(curr.swait,
              prev.swait) as swait,
    get_delta(curr.totalstop,
              prev.totalstop) as totalstop,
    get_delta(curr.trbl,
              prev.trbl) as trbl,
    get_delta(curr.trserr,
              prev.trserr) as trserr,
    get_delta(curr.unitadjust,
              prev.unitadjust) as unitadjust
