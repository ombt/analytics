...
create table if not exists u01.delta_pivot_count_2
(
    _filename_id numeric(30,0),
    _pcb_id text,
    _pcb_serial text,
...
create index if not exists idx_delta_pivot_count_2 on u01.delta_pivot_count_2
(
    _filename_id
) ;
...
insert into u01.delta_pivot_count_2
(
    _filename_id,
    _pcb_id,
    _pcb_serial,
