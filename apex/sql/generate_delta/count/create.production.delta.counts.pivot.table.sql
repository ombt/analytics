...
select
    ...
    get_delta(curr.board, prev.board) as board,
    ...
    get_delta(curr.lotboard, prev.lotboard) as lotboard,
    get_delta(curr.lotmodule, prev.lotmodule) as lotmodule,
    ...
    get_delta(curr.module, prev.module) as module,
    ...
    get_delta(curr.tdispense, prev.tdispense) as tdispense,
    get_delta(curr.tdmiss, prev.tdmiss) as tdmiss,
    get_delta(curr.thmiss, prev.thmiss) as thmiss,
    get_delta(curr.tmmiss, prev.tmmiss) as tmmiss,
    get_delta(curr.tmount, prev.tmount) as tmount,
    get_delta(curr.tpickup, prev.tpickup) as tpickup,
    get_delta(curr.tpmiss, prev.tpmiss) as tpmiss,
    get_delta(curr.tpriming, prev.tpriming) as tpriming,
    get_delta(curr.trbl, prev.trbl) as trbl,
    get_delta(curr.trmiss, prev.trmiss) as trmiss,
    get_delta(curr.trserr, prev.trserr) as trserr,
    get_delta(curr.trsmiss, prev.trsmiss) as trsmiss
