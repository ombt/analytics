...
create view u01.pcb_pa_aoi_data_per_machine_view
as
select distinct
    pa.ftf_filename_route,
    pa.ufd_machine_order,
    pa.ufd_lane_no,
    pa.ufd_stage_no,
    pa.ftf_filename_timestamp,
    pa.ftf_filename,
    pa.ftf_filename_type,
    pa.ftf_filename_id,
    pa.ufd_filename_id,
    pa.ufd_date,
    pa.ufd_pcb_serial,
    pa.ufd_pcb_id,
    pa.ufd_output_no,
    pa.ufd_pcb_id_lot_no,
    pa.ufd_pcb_id_serial_no,
    pa.upx_filename_id,
    pa.upx_author,
    pa.upx_authortype,
    pa.upx_comment,
    ...
    pa.dpt_trserr,
    pa.dpt_unitadjust,
    aoi.ufd_machine_order as aoi_ufd_machine_order,
    aoi.ufd_lane_no as aoi_ufd_lane_no,
    aoi.ufd_stage_no as aoi_ufd_stage_no,
    aoi.ufd_filename_id as aoi_ufd_filename_id,
    aoi.ufd_pcb_id as aoi_ufd_pcb_id,
    aoi.upx_mjsid as aoi_upx_mjsid,
    aoi.upi_lotname as aoi_upi_lotname,
    aoi.ap_cmp as aoi_ap_cmp,
    aoi.ap_board_status as aoi_ap_board_status,
    aoi.acmp_p as aoi_acmp_p,
    aoi.acmp_cmp as aoi_acmp_cmp
from
    u01.pa_pcb_totals_aoi_per_machine_view pa
left join
    u03.mqt_pcb_aoi_bad_per_machine_view aoi
on
    aoi.ufd_machine_order = pa.ufd_machine_order
and
    aoi.ufd_lane_no = pa.ufd_lane_no
and
    aoi.ufd_stage_no = pa.ufd_stage_no
and
    upper(aoi.ufd_pcb_id) = upper(pa.ufd_pcb_id)
and
    upper(aoi.upx_mjsid) = upper(pa.upx_mjsid)
and
    upper(aoi.upi_lotname) = upper(pa.upi_lotname)
;

create view u01.pcb_pa_aoi_status_per_machine_view
as
select distinct
    pa.ftf_filename_route,
    pa.ufd_machine_order,
