...
######################################################################
#
# process LNB data files, u01, u03, mpr and create reports, export
# data as CSV, HTML or SQL.
#
######################################################################
#
use strict;
...
use constant PROC_OPT_AUDITONLY => 8;
#
######################################################################
#
# globals
...
#
my %opts;
if (getopts('?hwWv:t:l:o:xd:', \%opts) != 1)
{
    usage($cmd);
    exit 2;
}
