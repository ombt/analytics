...
select
    ...
    prh.lane_no p_lnno,
    count(*) as p_c,
    sum(case when prh.trx_productid like '%+-+12+-+%' then 1 else 0 end) as p_c_12,
    sum(case when prh.trx_productid like '%+-+5+-+%' then 1 else 0 end) as p_c_5,
    sum(case when prh.trx_productid like '%+-+3+-+%' then 1 else 0 end) as p_c_3,
    sum(case when prh.trx_productid like '%+-+11+-+%' then 1 else 0 end) as p_c_11,
    sum(case when prh.trx_productid like '%+-+13+-+%' then 1 else 0 end) as p_c_13
from 
    production_reports_npm_hdr_raw prh
group by
    prh.equipment_id,
...
select
    ...
    zrh.lane_no z_lnno,
    count(*) as z_c,
    sum(case when zrh.trx_productid like '%+-+12+-+%' then 1 else 0 end) as z_c_12,
    sum(case when zrh.trx_productid like '%+-+5+-+%' then 1 else 0 end) as z_c_5,
    sum(case when zrh.trx_productid like '%+-+3+-+%' then 1 else 0 end) as z_c_3,
    sum(case when zrh.trx_productid like '%+-+11+-+%' then 1 else 0 end) as z_c_11,
    sum(case when zrh.trx_productid like '%+-+13+-+%' then 1 else 0 end) as z_c_13
from 
    z_cass_npm_hdr_raw zrh
group by
    zrh.equipment_id,
...
select
    ...
    count(*) as n_c,
    sum(case when nrh.trx_productid like '%+-+12+-+%' then 1 else 0 end) as n_c_12,
    sum(case when nrh.trx_productid like '%+-+5+-+%' then 1 else 0 end) as n_c_5,
    sum(case when nrh.trx_productid like '%+-+3+-+%' then 1 else 0 end) as n_c_3,
    sum(case when nrh.trx_productid like '%+-+11+-+%' then 1 else 0 end) as n_c_11,
    sum(case when nrh.trx_productid like '%+-+13+-+%' then 1 else 0 end) as n_c_13
from 
    nozzle_npm_hdr_raw nrh
group by
    nrh.equipment_id,
