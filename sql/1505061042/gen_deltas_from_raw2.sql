...
--     -- prev.eqid as prev_eqid, 
--     curr.lnno as curr_lnno, 
--     -- curr.rid as curr_rid, 
--     curr.slot as curr_slot, 
--     curr.sslot as curr_sslot, 
--     curr.cid as curr_cid,
--     curr.rfile as curr_rfile,
--     curr.pkup as curr_pkup,
--     curr.plc as curr_plc,
--     -- prev.lnno as prev_lnno, 
--     -- prev.rid as prev_rid, 
--     prev.slot as prev_slot, 
--     prev.sslot as prev_sslot, 
...
-- print N'Z_CASS_RAW_CTE GENERATED DELTA DATA WITH DELTAS = 0 ...';
-- go
-- 
-- with 
--     z_cass_cte (
...
-- go
-- 
-- print N'Z_CASS_RAW_CTE FILES WITH DELTAS = 0 ...';
-- go
-- 
-- with 
--     z_cass_cte (
...
--     curr.sslot = prev.sslot
-- and
--     sum(curr.pkup - prev.pkup) = 0
-- and
--     sum(curr.plc - prev.plc) = 0
-- order by
--     curr.eqid asc,
--     curr.lnno asc,
--     curr.curr_rfile asc
...
print N'Z_CASS_RAW_CTE FILES WITH DELTAS ...';
go
...
select distinct
    ...
    -- prev.pkup as prev_pkup,
    -- prev.plc as prev_plc,
    sum(curr.pkup - prev.pkup) as total_delta_pkup,
    sum(curr.plc - prev.plc) as total_delta_plc
from
    z_cass_cte curr
left outer join
    z_cass_cte prev
