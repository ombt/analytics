...
where
    prh.end_time >= 1425428806
and
    prh.end_time <= 1425438646
and
...
-- + env TZ=Asia/Ho_Chi_Minh date -d '2015-03-04 08:00:00' +%s
-- 1425456000
-- + env TZ=Asia/Ho_Chi_Minh date -d '2015-03-04 15:45:00' +%s
-- 1425483900
-- + env TZ=Asia/Ho_Chi_Minh date -d '2015-03-04 08:05:01' +%s
-- 1425456301
-- + env TZ=Asia/Ho_Chi_Minh date -d '2015-03-04 09:23:07' +%s
-- 1425460987
-- + env TZ=Asia/Ho_Chi_Minh date -d '2015-03-04 11:03:52' +%s
-- 1425467032
-- + env TZ=Asia/Ho_Chi_Minh date -d '2015-03-04 15:32:55' +%s
-- 1425483175
-- + exit 0
...
on
    prh.report_id = prd.report_id
where
    -- prh.end_time >= 1425456000
    prh.end_time >= 1425430800
and
    -- prh.end_time <= 1425483900
    prh.end_time <= 1425458700
and
    pd.product_name = 'LUNABEST_4074228'
group by
    prh.product_id,
