...
print N'+ env TZ=Asia/Vientiane date -d 2015-03-04 08:00:00 +%s';
print N'1425430800';
print N'+ env TZ=Asia/Vientiane date -d 2015-03-04 15:45:00 +%s';
print N'1425458700';
...
and
    prnh.end_time >= 1425430800
and
    prnh.end_time <= 1425458700
group by
    prnh.product_id,
    prnh.equipment_id,
    prnh.lane_no
...
print N'+ env TZ=Asia/Vientiane date -d 2015-03-04 08:00:00 +%s';
print N'1425430800 - 318';
print N'+ env TZ=Asia/Vientiane date -d 2015-03-04 15:45:00 +%s';
print N'1425458700 - 318';
