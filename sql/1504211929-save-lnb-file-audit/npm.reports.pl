...
sub audit_u01_name_value
{
    my ($pdb, $pu01, $section) = @_;
    #
    # check if we have the ignore output=12 option enabled. if so,
    # then go to a separate function to handle it. i really don't
    # want to make this decision over and over and over.
    #
    my $output_no = $pu01->{output_no};
    ...
    #{
        #
        # special processing required for count section in u01 
        # output=12 files. some fields are ignored.
        #
        #audit_output12_u01_count_name_value($pdb, $pu01, $section);
        #return;
    #}
    #
