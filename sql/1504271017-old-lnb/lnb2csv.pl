...
# process U03 files.
#
sub export_u03_mount_quality_trace_data
{
    my ($pdb) = @_;
    #
    ###############################################################
...
#
sub export_u03_mount_latest_reel_data
{
    my ($pdb) = @_;
    #
}
#
sub export_u03_mount_exchange_reel_data
{
    my ($pdb) = @_;
    #
}
...
sub export_u03_data
{
    my ($pdb) = @_;
    #
    export_u03_mount_quality_trace_data($pdb);
    export_u03_mount_latest_reel_data($pdb);
    export_u03_mount_exchange_reel_data($pdb);
}
#
