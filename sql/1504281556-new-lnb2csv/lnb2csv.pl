...
#
sub export_list_section
{
    my ($section, $file_type, $file_name, $do_product) = @_;
    #
    ...
    #
    open(my $outfh, ">" , "${export_dir}/${file_name}_BY_MACHINE_LANE_STAGE_FILENAME.csv") || die $!;
    #
    ...
    #
    open($outfh, ">" , "${export_dir}/${file_name}_BY_PRODUCT_MACHINE_LANE_STAGE_FILENAME.csv") || die $!;
    #
...
sub export_u03_data
{
    ...
    3
    export_list_section(MOUNTQUALITYTRACE, 
                        LNB_U03_FILE_TYPE(), 
                       'MOUNT_QUALITY_TRACE', 
                        TRUE);
    export_list_section(MOUNTLATESTREEL, 
                        LNB_U03_FILE_TYPE(), 
                       'MOUNT_LATEST_REEL', 
                        TRUE);
    export_list_section(MOUNTEXCHANGEREEL, 
                        LNB_U03_FILE_TYPE(), 
                       'MOUNT_EXCHANGE_REEL', 
                        TRUE);
}
...
sub export_mpr_data
{
    ...
    #
    export_list_section(TIMEDATASP, 
                        LNB_MPR_FILE_TYPE(), 
                       'TIME_DATA_SP', 
                        FALSE);
    export_list_section(COUNTDATASP, 
                        LNB_MPR_FILE_TYPE(), 
                       'COUNT_DATA_SP', 
                        FALSE);
    export_list_section(COUNTDATASP2, 
                        LNB_MPR_FILE_TYPE(), 
                       'COUNT_DATA_SP2', 
                        FALSE);
    export_list_section(TRACEDATASP, 
                        LNB_MPR_FILE_TYPE(), 
                       'TRACE_DATA_SP', 
                        FALSE);
    export_list_section(TRACEDATASP_2, 
                        LNB_MPR_FILE_TYPE(), 
                       'TRACE_DATA_SP_2', 
                        FALSE);
    export_list_section(ISPINFODATA, 
                        LNB_MPR_FILE_TYPE(), 
                       'ISP_INFO_DATA', 
                        FALSE);
    export_list_section(MASKISPINFODATA, 
                        LNB_MPR_FILE_TYPE(), 
                       'MASK_ISP_INFO_DATA', 
                        FALSE);
}
