...
sub read_file
{
    ...
    #
    printf $log_fh "\tReading CRB file (%d): %s\n", 
                   __LINE__, $crb_file;
    #
    if ( ! -r $crb_file )
    {
...
sub process_data
{
    ...
    #
    printf $log_fh "\tProcessing CRB data (%d0: %s\n", 
                   __LINE__, $crb_file;
    #
    return SUCCESS;
}
...
sub export_to_csv
{
    ...
    #
    printf $log_fh "\tWriting CRB data to CSV (%d): %s\n", 
                   __LINE__, $crb_file;
    #
    return SUCCESS;
}
