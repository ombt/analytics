...
select
    ...
    -- prkxh.report_file
    -- prkx.report_id,
    prkx.stage_no as prkx_stage_no, 
    -- sum(prkx.total_run_time as prkx_total_run_time, 
    prkx.real_run_time as prkx_real_run_time, 
    prkx.total_down_time as prkx_total_down_time, 
    prkx.prev_proc_wait_time as prkx_prev_proc_wait_time, 
    prkx.next_proc_wait_time as prkx_next_proc_wait_time, 
    prkx.singl_cycl_stop_time as prkx_singl_cycl_stop_time, 
    prkx.chip_supp_wait_time as prkx_chip_supp_wait_time, 
    prkx.sldr_ctr_wait_time as prkx_sldr_ctr_wait_time, 
    prkx.sldr_snsr_wait_time as prkx_sldr_snsr_wait_time, 
    prkx.cln_paper_wait_time as prkx_cln_paper_wait_time,
    prkx.boards_produced as prkx_boards_produced, 
    prkx.blocks_produced as prkx_blocks_produced
from
    routes r
inner join
    route_layout rl
...
select
    ...
    -- prkxh.report_file
    -- prkx.report_id,
    prkx.stage_no as raw_stage_no, 
    -- sum(prkx.total_run_time as raw_total_run_time, 
    prkx.real_run_time as raw_real_run_time, 
    prkx.total_down_time as raw_total_down_time, 
    prkx.prev_proc_wait_time as raw_prev_proc_wait_time, 
    prkx.next_proc_wait_time as raw_next_proc_wait_time, 
    prkx.singl_cycl_stop_time as raw_singl_cycl_stop_time, 
    prkx.chip_supp_wait_time as raw_chip_supp_wait_time, 
    prkx.sldr_ctr_wait_time as raw_sldr_ctr_wait_time, 
    prkx.sldr_snsr_wait_time as raw_sldr_snsr_wait_time, 
    prkx.cln_paper_wait_time as raw_cln_paper_wait_time,
    prkx.total_down_cnt as raw_total_down_cnt,
    -- prkx.prev_proc_wait_cnt as raw_prev_proc_wait_cnt,
    -- prkx.next_proc_wait_cnt as raw_next_proc_wait_cnt,
    prkx.singl_cycl_stop_cnt as raw_singl_cycl_stop_cnt,
    prkx.chip_supp_wait_cnt as raw_chip_supp_wait_cnt,
    prkx.sldr_ctr_wait_cnt as raw_sldr_ctr_wait_cnt,
    prkx.sldr_snsr_wait_cnt as raw_sldr_snsr_wait_cnt,
    prkx.cln_paper_wait_cnt as raw_cln_paper_wait_cnt,
    prkx.start_imp_stop_cnt as raw_start_imp_stop_cnt
    -- prkx.singl_cycl_err_cnt as raw_singl_cycl_err_cnt,
    -- prkx.chip_eject_err_cnt as raw_chip_eject_err_cnt,
    -- prkx.chip_mount_err_cnt as raw_chip_mount_err_cnt,
    -- prkx.chip_recog_err_cnt as raw_chip_recog_err_cnt,
    -- prkx.chip_errect_err_cnt as raw_chip_errect_err_cnt,
    -- prkx.chip_pickup_err_cnt as raw_chip_pickup_err_cnt,
    -- prkx.transport_err_cnt as raw_transport_err_cnt,
    -- prkx.mntpt_recog_err_cnt as raw_mntpt_recog_err_cnt,
    -- prkx.pcb_recog_err_cnt as raw_pcb_recog_err_cnt,
    -- prkx.pcb_elong_err_cnt as raw_pcb_elong_err_cnt,
    -- prkx.paste_cntup_err_cnt as raw_paste_cntup_err_cnt,
    -- prkx.mask_recog_err_cnt as raw_mask_recog_err_cnt,
    -- prkx.feedback_err_cnt as raw_feedback_err_cnt,
    -- prkx.bond_recog_err_cnt as raw_bond_recog_err_cnt,
    -- prkx.other_error_cnt as raw_other_error_cnt,
from
    routes r
inner join
    route_layout rl
...
select
    ...
    -- prkx.report_id,
    prkx.stage_no as prkx_stage_no, 
    -- prkx.total_run_time as prkx_total_run_time, 
    prkx.real_run_time as prkx_real_run_time, 
    prkx.total_down_time as prkx_total_down_time, 
    prkx.prev_proc_wait_time as prkx_prev_proc_wait_time, 
    prkx.next_proc_wait_time as prkx_next_proc_wait_time, 
    ...
    prkx.sldr_snsr_wait_time as prkx_sldr_snsr_wait_time, 
    prkx.cln_paper_wait_time as prkx_cln_paper_wait_time,
    prkx.total_down_cnt as prkx_total_down_cnt,
    -- prkx.prev_proc_wait_cnt as prkx_prev_proc_wait_cnt,
    -- prkx.next_proc_wait_cnt as prkx_next_proc_wait_cnt,
    prkx.singl_cycl_stop_cnt as prkx_singl_cycl_stop_cnt,
    prkx.chip_supp_wait_cnt as prkx_chip_supp_wait_cnt,
    prkx.sldr_ctr_wait_cnt as prkx_sldr_ctr_wait_cnt,
    prkx.sldr_snsr_wait_cnt as prkx_sldr_snsr_wait_cnt,
    prkx.cln_paper_wait_cnt as prkx_cln_paper_wait_cnt,
    prkx.start_imp_stop_cnt as prkx_start_imp_stop_cnt
    -- prkx.singl_cycl_err_cnt as prkx_singl_cycl_err_cnt,
    -- prkx.chip_eject_err_cnt as prkx_chip_eject_err_cnt,
    -- prkx.chip_mount_err_cnt as prkx_chip_mount_err_cnt,
    -- prkx.chip_recog_err_cnt as prkx_chip_recog_err_cnt,
    -- prkx.chip_errect_err_cnt as prkx_chip_errect_err_cnt,
    -- prkx.chip_pickup_err_cnt as prkx_chip_pickup_err_cnt,
    -- prkx.transport_err_cnt as prkx_transport_err_cnt,
    -- prkx.mntpt_recog_err_cnt as prkx_mntpt_recog_err_cnt,
    -- prkx.pcb_recog_err_cnt as prkx_pcb_recog_err_cnt,
    -- prkx.pcb_elong_err_cnt as prkx_pcb_elong_err_cnt,
    -- prkx.paste_cntup_err_cnt as prkx_paste_cntup_err_cnt,
    -- prkx.mask_recog_err_cnt as prkx_mask_recog_err_cnt,
    -- prkx.feedback_err_cnt as prkx_feedback_err_cnt,
    -- prkx.bond_recog_err_cnt as prkx_bond_recog_err_cnt,
    -- prkx.other_error_cnt as prkx_other_error_cnt,
from
    routes r
inner join
    route_layout rl
...
print N'Delta Data including Counts generated from Raw data for by route_id, equipment_id, lane_no, and stage_no for given times';
...
with prod_kx_cte (
    ...
    select
        ...
        -- prkx.sldr_snsr_wait_time as sldr_snsr_wait_time, 
        -- prkx.cln_paper_wait_time as cln_paper_wait_time,
        prkx.total_down_cnt as total_down_cnt,
        -- prkx.prev_proc_wait_cnt as prev_proc_wait_cnt,
        -- prkx.next_proc_wait_cnt as next_proc_wait_cnt,
        prkx.singl_cycl_stop_cnt as singl_cycl_stop_cnt,
        prkx.chip_supp_wait_cnt as chip_supp_wait_cnt,
        prkx.sldr_ctr_wait_cnt as sldr_ctr_wait_cnt,
        prkx.sldr_snsr_wait_cnt as sldr_snsr_wait_cnt,
        prkx.cln_paper_wait_cnt as cln_paper_wait_cnt,
        prkx.start_imp_stop_cnt as start_imp_stop_cnt,
        -- prkx.singl_cycl_err_cnt as singl_cycl_err_cnt,
        -- prkx.chip_eject_err_cnt as chip_eject_err_cnt,
        -- prkx.chip_mount_err_cnt as chip_mount_err_cnt,
        -- prkx.chip_recog_err_cnt as chip_recog_err_cnt,
        -- prkx.chip_errect_err_cnt as chip_errect_err_cnt,
        -- prkx.chip_pickup_err_cnt as chip_pickup_err_cnt,
        -- prkx.transport_err_cnt as transport_err_cnt,
        -- prkx.mntpt_recog_err_cnt as mntpt_recog_err_cnt,
        -- prkx.pcb_recog_err_cnt as pcb_recog_err_cnt,
        -- prkx.pcb_elong_err_cnt as pcb_elong_err_cnt,
        -- prkx.paste_cntup_err_cnt as paste_cntup_err_cnt,
        -- prkx.mask_recog_err_cnt as mask_recog_err_cnt,
        -- prkx.feedback_err_cnt as feedback_err_cnt,
        -- prkx.bond_recog_err_cnt as bond_recog_err_cnt,
        -- prkx.other_error_cnt as other_error_cnt,
        row_number() over (
            partition by 
                r.route_id,
                m.equipment_id,
...
select 
    ...
    -- curr.cln_paper_wait_time - prev.cln_paper_wait_time 
        -- as delta_cln_paper_wait_time
    curr.total_down_cnt - prev.total_down_cnt as delta_total_down_cnt,
    -- curr.prev_proc_wait_cnt - prev.prev_proc_wait_cnt as delta_prev_proc_wait_cnt,
    -- curr.next_proc_wait_cnt - prev.next_proc_wait_cnt as delta_next_proc_wait_cnt,
    curr.singl_cycl_stop_cnt - prev.singl_cycl_stop_cnt as delta_singl_cycl_stop_cnt,
    curr.chip_supp_wait_cnt - prev.chip_supp_wait_cnt as delta_chip_supp_wait_cnt,
    curr.sldr_ctr_wait_cnt - prev.sldr_ctr_wait_cnt as delta_sldr_ctr_wait_cnt,
    curr.sldr_snsr_wait_cnt - prev.sldr_snsr_wait_cnt as delta_sldr_snsr_wait_cnt,
    curr.cln_paper_wait_cnt - prev.cln_paper_wait_cnt as delta_cln_paper_wait_cnt,
    curr.start_imp_stop_cnt - prev.start_imp_stop_cnt as delta_start_imp_stop_cnt
    -- curr.singl_cycl_err_cnt - prev.singl_cycl_err_cnt as delta_singl_cycl_err_cnt,
    -- curr.chip_eject_err_cnt - prev.chip_eject_err_cnt as delta_chip_eject_err_cnt,
    -- curr.chip_mount_err_cnt - prev.chip_mount_err_cnt as delta_chip_mount_err_cnt,
    -- curr.chip_recog_err_cnt - prev.chip_recog_err_cnt as delta_chip_recog_err_cnt,
    -- curr.chip_errect_err_cnt - prev.chip_errect_err_cnt as delta_chip_errect_err_cnt,
    -- curr.chip_pickup_err_cnt - prev.chip_pickup_err_cnt as delta_chip_pickup_err_cnt,
    -- curr.transport_err_cnt - prev.transport_err_cnt as delta_transport_err_cnt,
    -- curr.mntpt_recog_err_cnt - prev.mntpt_recog_err_cnt as delta_mntpt_recog_err_cnt,
    -- curr.pcb_recog_err_cnt - prev.pcb_recog_err_cnt as delta_pcb_recog_err_cnt,
    -- curr.pcb_elong_err_cnt - prev.pcb_elong_err_cnt as delta_pcb_elong_err_cnt,
    -- curr.paste_cntup_err_cnt - prev.paste_cntup_err_cnt as delta_paste_cntup_err_cnt,
    -- curr.mask_recog_err_cnt - prev.mask_recog_err_cnt as delta_mask_recog_err_cnt,
    -- curr.feedback_err_cnt - prev.feedback_err_cnt as delta_feedback_err_cnt,
    -- curr.bond_recog_err_cnt - prev.bond_recog_err_cnt as delta_bond_recog_err_cnt,
    -- curr.other_error_cnt - prev.other_error_cnt as delta_other_error_cnt,
from
    prod_kx_cte curr
left outer join
    prod_kx_cte prev
