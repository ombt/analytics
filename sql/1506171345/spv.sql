...
select 
    ...
    prnhbb.lane_no,
    prnhbb.job_id,
    prnhbb.trx_productid,
    prnhbb.stage,
    prnhbb.timestamp,
    prnhbb.prev_report_id
from
    production_reports_npm_hdr_by_board prnhbb
go

select 
    count(*) as 'count_of_lane_eq_1_mach_eq_1'
from
    production_reports_npm_hdr_by_board prnhbb
where
    prnhbb.lane_no = 1
and
    prnhbb.trx_productid like '%-01-%'
go

select 
    count(*) as 'count_of_lane_eq_2_mach_eq_2'
from
    production_reports_npm_hdr_by_board prnhbb
where
    prnhbb.lane_no = 2
and
    prnhbb.trx_productid like '%-02-%'
go

select 
    count(*) as 'count_of_lane_ne_1_mach_eq_1'
from
    production_reports_npm_hdr_by_board prnhbb
where
    prnhbb.lane_no <> 1
...
select 
    count(*) as 'count_of_lane_ne_2_mach_eq_2'
from
    production_reports_npm_hdr_by_board prnhbb
where
    prnhbb.lane_no <> 2
