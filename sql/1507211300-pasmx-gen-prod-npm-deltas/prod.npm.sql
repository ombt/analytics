...
--     p.caerr_time,
--     p.cpwait_time,
--     p.mskrecerrstop_time,
--     p.mskpstrecerrstop_time,
--     p.bprcgstop_time,
--     p.sothrstop_time,
--     p.pcustop_time,
--     p.bestop_time,
...
--     p.caerr_count,
--     p.cpwait_count,
--     p.mskrecerrstop_count,
--     p.mskpstrecerrstop_count,
--     p.bprcgstop_count,
--     p.sothrstop_count,
--     p.pcustop_count,
--     p.bestop_count,
...
--     p.hcwait_count,
--     p.hswait_count,
--     p.pstrecerrstop_count,
--     p.total_count,
--     p.solvnonstop_count,
--     p.spdlenerrstop_time,
--     p.spdpstcntupstop_time,
--     p.spdpstnonstop_time,
--     p.spdpapernonstop_time,
--     p.spdmskrecerrstop_time,
--     p.spdpstrecerrstop_time,
--     p.spdsolvnonstop_time,
--     p.spdlenerrstop_count,
--     p.spdpstcntupstop_count,
--     p.spdpstnonstop_count,
--     p.spdpapernonstop_count,
--     p.spdmskrecerrstop_count,
--     p.spdpstrecerrstop_count,
--     p.spdsolvnonstop_count,
--     p.spdreccnt_count,
--     p.spdprintcnt_count,
--     p.spdclncnt_count,
--     p.spdpstsupplycnt_count,
--     p.spdfbclncnt_count,
--     p.spdfbprintcnt_count,
--     p.spdrestorationcnt_count,
--     p.jwait_time
--     pd.product_id,
--     pd dos_product_name
...
--     pd base_product_id
    ...
    ph.product_id,
    pd.product_name,
    count(p.tpickup) count_tpickup_le_10000
from
    production_reports_npm_hdr ph
inner join
    production_reports_npm p
on
    p.report_id = ph.report_id
left join
    product_data pd
on
    pd.product_id = ph.product_id
where
    p.tpickup <= 10000
group by
    ph.equipment_id,
...
--     pd base_product_id
    ...
    ph.product_id,
    pd.product_name,
    count(p.tpickup) count_tpickup_gt_10000
from
    production_reports_npm_hdr ph
inner join
    production_reports_npm p
...
inner join
    zone_layout zl
on
    zl.equipment_id = ph.equipment_id
inner join
    route_layout rl
on
    rl.zone_id = zl.zone_id
inner join
    routes r
on
...
where
    p.tpickup > 10000
and
    ph.end_time >= 1429646400
and
    ph.end_time <= 1429732800
order by
    ph.equipment_id asc,
    ph.lane_no asc,
    ph.stage asc,
