...
from
    production_reports_npm_hdr_by_board prh
left join
    production_reports_npm_by_board prd
on
    prh.report_id = prd.report_id
where
    prh.end_time >= 1443010981
and
    prh.end_time <= 1443041519
group by
    -- prh.product_id,
    prh.equipment_id,
    -- prh.setup_id,
...
where
	h.end_time >= 1443010981
and
	h.end_time <= 1443041519
and 
